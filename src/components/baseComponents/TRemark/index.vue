          ...
          <div class="el-row form-horizontal">
            ...
            >
              <el-input
                ...
                clearable
              ></el-input>
              <timer-btn class="timer" :second="second" @click="sendCode" />
            </el-form-item>
          </div>
        </el-form>
...
export default {
  ...
  methods: {
    ...
    remarkConfirm () {
      ...
      this.$emit('remarkConfirm', this.remark, this.callBackFunc, this.callBackFuncParam)
      // this.remark = ''
    },
    // 备注确定打开手机验证
    remarkOpen () {
    ...
    phoneConfirm () {
      this.$refs.phoneForm.validate(valid => {
        if (valid) {
          ...
          this.phoneDialog = false
          this.$emit('phoneConfirm', this.phoneRemark, this.callBackFunc, this.callBackFuncParam, this.phoneForm.code)
          this.reset()
        } else {
          return false
        }
    ...
    //   const res = await this.$ajaxRequest('get', 'verifyCode', obj)
    //   if (res && res.status === 200) {
    //     this.phoneDialog = false
    //     // console.log(11, this.phoneRemark)
    //     this.$emit('phoneConfirm', this.phoneRemark, this.callBackFunc, this.callBackFuncParam, this.phoneForm.code)
    //     this.remark = ''
    //   } else {
