        ...
        <ul class="el-upload-list el-upload-list--picture-card">
          ...
          >
            <img
              :src="item.url"
              class="el-upload-list__item-thumbnail pointer"
              @click="onPreview4show(item.url)"
              alt
              v-if="(/.png|.jpg|.jpeg|.PNG|.JPG|.JPEG/).test(item.name)"
            />
            <img
              :src="downloadFixedIcon(item.name)"
              class="el-upload-list__item-thumbnail pointer"
...
export default {
  ...
  data () {
    return {
      ...
      showFileList: [],
      downloadFixedIcons: [
        { type: 0, url: require(`@/assets/img/fileType/file.png`) },
        { type: 1, url: require(`@/assets/img/fileType/doc.png`) },
        { type: 2, url: require(`@/assets/img/fileType/ppt.png`) },
        { type: 3, url: require(`@/assets/img/fileType/xls.png`) },
        { type: 4, url: require(`@/assets/img/fileType/txt.png`) },
        { type: 5, url: require(`@/assets/img/fileType/pdf.png`) },
        { type: 6, url: require(`@/assets/img/fileType/zip.png`) },
        { type: 7, url: require(`@/assets/img/fileType/rar.png`) }
      ]
    }
  },
  props: {
    ...
    fileType: {
      type: String,
      // default: '.jpg,.jpeg,.bmp,.png,.gif,.pdf,.doc,.docx,.xls,.xlsx,.txt,.rar,.zip,.JPG,.JPEG,.PNG,.BMP,.GIF,.PDF,.DOC,.DOCX,.XLS,.XLSX,.TXT,.RAR,.ZIP'
  ...
  methods: {
    ...
    downloadFixedIcon (item) {
      if ((/.bmp|.gif/).test(item)) {
        ...
        //   return this.downloadFixedIcons[2].url
